...
✅ What Does "WIF" Stand For?
    ...
    means → “Did the child exit normally?”
    ...
    Child prints, sleeps, exits with status 42.

    Parent waits for that child using waitpid().

    Parent checks exit status and prints it.
